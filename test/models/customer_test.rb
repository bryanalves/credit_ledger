...
class CustomerTest < ActiveSupport::TestCase
  describe "search" do
    ...
    it "finds users by email" do
      ...
      Customer.search('PASS@example.com').must_equal [expected]
    end
    ...
    it "finds multiple users" do
      ...
      Customer.search('PASS').must_equal [expected, expected2]
    end

    it "doesn't match other search terms" do
      FactoryGirl.create(:customer, first_name: 'FAIL')
      Customer.search('something').must_be_empty
    end
  end
end
